...
// @material-ui/icons
import { Apps, FlightTakeoff, AccountBox, LocalFlorist, Home, Info } from "@material-ui/icons";
...
export default function HeaderLinks(props) {
    ...
    return (
        <List className={classes.list}>
            ...
            <ListItem className={classes.listItem}>
                <Link to="/tour" className={classes.navLink}>
                    <FlightTakeoff className={classes.icons} />
                    Tour
                </Link>
            </ListItem>
            <ListItem className={classes.listItem}>
                <Link to="/food" className={classes.navLink}>
